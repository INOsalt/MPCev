...
def model_train(batch_size, model, epochs, loss_function, optimizer, train_loader, test_loader):
...
batch_size = 64
epochs = 100
model_train(batch_size, model, epochs, loss_function, optimizer, train_loader, test_loader)
# 模型预测
# 模型 测试集 验证
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
